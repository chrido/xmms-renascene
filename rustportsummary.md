...
- Added Rust Spotify auth/config groundwork: C-compatible API/auth constants, authorization URL construction, `spotify.conf` refresh-token load/save behavior, and e2e coverage for the persisted auth contract.
