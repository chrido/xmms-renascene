...
- Added deterministic Rust podcast integration helpers for feed/direct-stream detection, RSS/Atom enclosure parsing, relative URL resolution, feed/guid/title fallbacks, SHA-256 cache paths, cache freshness/TTL cleanup planning, playback cache URI selection, retry delays, and refresh scheduling, with e2e coverage.
